...
$e_subject = 'You\'ve been contacted by ' . $visitor_name . '.';

// You can change this if you feel that you need to.
$e_body = "You have been contacted by $visitor_name with additional message is as follows." . PHP_EOL . PHP_EOL;
$e_content = "\"$visitor_comment\"" . PHP_EOL . PHP_EOL;
$e_reply = "You can contact $visitor_name via email, $visitor_email or via phone $visitor_phone";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "Thank you <strong>$visitor_name</strong>,<br> your message has been submitted. We will contact you shortly.";
	echo "</div>";
